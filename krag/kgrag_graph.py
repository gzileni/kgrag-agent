...
from typing import Literal, LiteralString, AsyncGenerator, Any
...
class MemoryStoreGraph(MemoryPersistence):
    """
    ...
    def __init__(self, **kwargs):
        ...
        self.process_parallelism = kwargs.get("process_parallelism", 10)
    ...
    async def _llm_parser(self, prompt_text) -> GraphComponents:
        """
    ...
    async def _extract_graph_components(self, raw_data: str):
        """
        ...
        parsed_response = await self._llm_parser(prompt)
    ...
    def _ingest_to_neo4j(self, nodes, relationships):
        """
    ...
    def _retriever_search(self, query):
        """
