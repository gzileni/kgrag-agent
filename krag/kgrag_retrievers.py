...
class MemoryStoreRetriever(MemoryStoreGraph):
    """
    ...
    def cache_path(self) -> str:
        """
        Returns the root cache directory for the project.
        """
        abs_path = os.path.abspath(__file__)
        parent_dir = os.path.dirname(abs_path)
        project_root = os.path.dirname(parent_dir)
        return os.path.join(project_root, ".qi_memory_cache.csv")
    ...
    async def _update_cache(self, file_name: str, error: bool = False) -> None:
        """
    ...
    def _create_download_dir(self, path: str, delete: bool = False) -> str:
        """
